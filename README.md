...
![Swift](https://img.shields.io/badge/Swift-0A0A0A?style=flat-square&logo=swift&logoColor=F5E642)
...
| # | Proyecto | Stack | |
|---|---|---|---|
| `01` | **gonzalotellado.com** — Portfolio personal, diseño propio | Next.js · Framer Motion · Cloudflare | [↗](https://gonzalotellado.com) |
| `02` | **Vault** — App iOS de finanzas personales con IA on-device y conversor de divisas en tiempo real | Swift · SwiftUI · Apple Intelligence | — |
| `03` | **Más proyectos** — Proyectos de clase, experimentos y más | — | [↗](https://github.com/gonza-code) |
...
`∞ cafés con avena consumidos` · Disponible para nuevas oportunidades
